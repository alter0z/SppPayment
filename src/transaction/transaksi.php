            ...
            <div class="table-responsive">
              <table id="tabletrans" class="table table-responsive-md">
				...
				<?php
					...
					$sql = mysqli_query($conn, "SELECT a.*, b.*, c.* FROM transaksi as a join student as b on a.nis = b.nis join wclass as c on b.class = c.class join spp as d on a.nis = d.nis");
